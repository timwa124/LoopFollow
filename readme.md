We want to use Loop Follow with FreeAPS-X but this was just limited. You're not able to see COB / IOB and as well the carb dots and Insulin Dots are missing.
